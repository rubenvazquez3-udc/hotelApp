...
import static es.udc.hotelapp.backend.rest.dtos.UserConversor.toAuthenticatedUserDto;
import static es.udc.hotelapp.backend.rest.dtos.UserConversor.toUser;
import static es.udc.hotelapp.backend.rest.dtos.UserConversor.toUserDto;
...
import es.udc.hotelapp.backend.rest.common.JwtGenerator;
import es.udc.hotelapp.backend.rest.common.JwtInfo;
import es.udc.hotelapp.backend.rest.dtos.AuthenticatedUserDto;
import es.udc.hotelapp.backend.rest.dtos.ChangePasswordParamsDto;
import es.udc.hotelapp.backend.rest.dtos.LoginParamsDto;
import es.udc.hotelapp.backend.rest.dtos.UserDto;
