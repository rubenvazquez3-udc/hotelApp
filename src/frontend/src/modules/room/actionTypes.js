...
export const FIND_ALL_ROOM_TYPES_COMPLETED = "project/room/findAllRoomTypes";
export const REMOVE_ROOM_COMPLETED = 'project/room/removeRoomCompleted';
export const CLEAR_ROOMS_COMPLETED = 'project/room/clearRoomsCompleted';